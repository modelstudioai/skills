...
- **1st-party skills** — Developed by the Bailian team and paired with [`bailian-cli`](https://www.npmjs.com/package/bailian-cli) (`bl`), covering chat, multimodal, image/video, speech, vision, apps, memory, RAG, and web search on the Bailian platform.
...
| Skill | Description |
|-------|-------------|
| [`bailian-cli`](./skills/bailian-cli/) | Guides the Agent to use `bl` commands for chat, multimodal, image/video, speech, vision, apps, memory, RAG, and web search; detailed command reference under `reference/`. |
