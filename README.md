...
| [`media-utils`](./skills/media-utils/) | **Deterministic multimedia processing and meeting cleanup**: inspect and safely transform audio, images, and video with ffmpeg/ffprobe; `meeting-cleanup` offers exact-rule and multilingual AI semantic cleanup, Bailian ASR speaker diarization, reviewed smooth cuts, and matching speaker-labelled SRT. |
