...
-   [Parse 文档解析](raw/application-user-guide/getting-started-overview/overview.md)：将文件解析为便于阅读、检索与下游处理的内容。
-   [Extract 信息提取](raw/application-user-guide/getting-started-overview/extract-overview.md)：根据业务字段定义，从文档中提取关键字段结果。
