...
调用 [AddMemory](https://help.aliyun.com/zh/model-studio/long-term-memory-api-reference) 接口，将对话传入记忆库。调用前需配置 `DASHSCOPE_API_KEY`，获取方式请参考[获取 API Key](raw/model-api-reference/preparations/get-api-key.md)。
