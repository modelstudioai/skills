...
基于大模型，依据指定的知识库自动生成评测集。仅支持生成[知识问答](https://help.aliyun.com/zh/model-studio/application-evaluation-dataset#c5d76de52fwqy)类型的评测任务，详情请参考[自动评测](https://help.aliyun.com/zh/model-studio/application-auto-evaluation#2a4636d8e0eav)。

### 手动上传

手动上传支持[对话分析](https://help.aliyun.com/zh/model-studio/application-evaluation-dataset#8f7c2c86dcq7k)和[知识问答](https://help.aliyun.com/zh/model-studio/application-evaluation-dataset#c5d76de52fwqy)两种类型的评测集。
