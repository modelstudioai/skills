...
-   对话分析：适用于[人工评测](raw/application-user-guide/application-evaluation/evaluate-manual-application.md)，通过构造单轮或多轮对话，对应用的输出结果进行人工打分和评估。
-   知识问答：适用于[自动评测](raw/application-user-guide/application-evaluation/application-auto-evaluation.md)，通过提供问题、标准答案和关键词，利用大模型对应用输出结果的准确性进行自动打分和评估。
...
基于大模型，依据指定的知识库自动生成评测集。仅支持生成[知识问答](https://help.aliyun.com/zh/model-studio/application-evaluation-dataset#e425be30e29j7)类型的评测任务，详情请参考[自动评测](https://help.aliyun.com/zh/model-studio/application-auto-evaluation#3ecb366328ml8)。

### 手动上传

手动上传支持[对话分析](https://help.aliyun.com/zh/model-studio/application-evaluation-dataset#7fd8bf590djpn)和[知识问答](https://help.aliyun.com/zh/model-studio/application-evaluation-dataset#e425be30e29j7)两种类型的评测集。
...
3.  完成修改后，单击**发布确认发布**，即可将修改后的评测集发布为新的版本。
