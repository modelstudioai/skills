...
4.  子账号（RAM用户）需获取`管理员`或`应用评测-操作`权限，才能够使用自动评测功能。详情可参考[页面权限](https://help.aliyun.com/zh/model-studio/member-management)。
...
2.  **分析归因，定位问题**：根据系统给出的归因类型，参考[归因分析](https://help.aliyun.com/zh/model-studio/application-auto-evaluation#cbfc8d12a0csd)中的说明，快速定位每个 BadCase 的产生原因。
