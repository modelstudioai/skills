...
4.  **提交解析**
    ...
    1.  确认选定文件与本次设置。
    2.  点击「运行文档解析」。
    3.  等待任务完成；需要查看处理进度时，进入[任务记录](raw/application-user-guide/getting-started-overview/settings-configurations/tasks.md)。
...
6.  **返回历史结果**
    ...
    进入[任务记录](raw/application-user-guide/getting-started-overview/settings-configurations/tasks.md)，找到对应解析任务，查看详情并从结果入口返回查看。
