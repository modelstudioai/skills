...
​调用前请确保已获取 API Key，详见[提交解析任务](raw/application-api-reference/api-overview/document-parsing/parse-submit.md)、[查询解析任务](raw/application-api-reference/api-overview/document-parsing/parse-result.md)。
...
​调用前请确保已获取 API Key，详见[提交解析任务](raw/application-api-reference/api-overview/field-extraction/extract-submit.md)、[查询解析任务](raw/application-api-reference/api-overview/field-extraction/extract-result.md)。
