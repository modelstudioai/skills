...
开通并创建伶鹊CCAI-AIO对话分析并创建应用，请参考[使用指南](raw/application-user-guide/application-gallery/official-application-lingque-ccai-dialogue-analysis-aio/lingque-ccai-aio-user-guide.md)。
