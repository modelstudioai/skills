...
如果您使用子账号调用接口，请参考[通义晓蜜CCAI-对话分析RAM子账号使用方式和授权操作](https://help.aliyun.com/zh/model-studio/lingque-ccai-dialogue-analytics-ram-subaccount-usage-and-authorization-procedures)。
