# CreateTask - 通过上传离线任务数据进行通义晓蜜CCAI-对话分析
...
[调试](https://api.aliyun.com/api/ContactCenterAI/2024-06-03/CreateTask)
...
单轨音频自动区分通话人，取值：0 为自动识别，取值：1 为不自动识别；默认：1；备注：只适用于 8k 采样率音频文件
...
语音转写模型，取值 asr （小模型），paraformer（大模型）
...
自动识别通话角色，true 为自动识别，false 为不自动识别。默认：false
...
识别语言，默认值为中文普通话，其他支持的语种和方言请联系客服
