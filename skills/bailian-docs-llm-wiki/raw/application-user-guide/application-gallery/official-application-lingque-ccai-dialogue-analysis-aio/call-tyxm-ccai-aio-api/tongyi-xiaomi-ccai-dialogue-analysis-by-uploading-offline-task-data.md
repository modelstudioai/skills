# 通过上传离线任务数据进行伶鹊CCAI-对话分析

本文向您介绍一个通过上传离线任务数据进行伶鹊CCAI-对话分析的最佳实践。
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6889763871/p1086584.png)

1.  访问**[应用广场](https://bailian.console.aliyun.com/#/app-market)**页面，点击**应用实践**。
2.  在应用实践列表中找到点击伶鹊CCAI-对话分析AIO的**立即查看**。
...
关于任务类型，请参[通过上传离线任务数据进行伶鹊CCAI-对话分析](raw/application-user-guide/application-gallery/official-application-lingque-ccai-dialogue-analysis-aio/api-reference-2/api-contactcenterai-2024-06-03-dir/api-contactcenterai-2024-06-03-createtask.md)见中resultTypes字段的描述。
