...
[调试](https://api.aliyun.com/api/DataAnalysisGBI/2024-08-23/UpdateSynonyms)
...
```
POST /gbi/update/synonyms HTTP/1.1
```
...
如果需要关联到数据表的某个具体的列，则可以在这里填写具体的列名，形式为：表名.列名
...
如果需要关联到数据表的某个具体的列，则可以在这里填写具体的列名
