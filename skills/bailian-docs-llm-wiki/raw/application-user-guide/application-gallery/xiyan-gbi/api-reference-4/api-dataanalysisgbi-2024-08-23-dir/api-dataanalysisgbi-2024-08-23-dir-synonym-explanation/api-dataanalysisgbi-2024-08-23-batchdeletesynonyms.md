...
[调试](https://api.aliyun.com/api/DataAnalysisGBI/2024-08-23/BatchDeleteSynonyms)
...
```
POST /gbi/batchDelete/synonyms HTTP/1.1
```
...
synonym-AAAAAAAAh6cWOUPagYstkg
