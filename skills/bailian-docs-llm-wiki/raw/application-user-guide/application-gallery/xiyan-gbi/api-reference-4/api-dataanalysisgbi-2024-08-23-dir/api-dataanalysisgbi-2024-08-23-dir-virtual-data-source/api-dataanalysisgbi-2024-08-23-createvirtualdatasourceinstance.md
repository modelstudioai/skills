# CreateVirtualDatasourceInstance - 创建虚拟数据源实例
...
[调试](https://api.aliyun.com/api/DataAnalysisGBI/2024-08-23/CreateVirtualDatasourceInstance)
...
```
POST /gbi/virtualDatasource/createVirtualDatasourceInstance HTTP/1.1
```
