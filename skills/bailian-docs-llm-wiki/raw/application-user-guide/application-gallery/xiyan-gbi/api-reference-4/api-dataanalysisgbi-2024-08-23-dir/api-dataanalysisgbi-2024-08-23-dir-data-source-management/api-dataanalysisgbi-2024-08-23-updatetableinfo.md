...
[调试](https://api.aliyun.com/api/DataAnalysisGBI/2024-08-23/UpdateTableInfo)
...
```
POST /gbi/update/table HTTP/1.1
```
...
当前这张表的外键关系列表，采用“表名.列名=表名.列名”的形式
