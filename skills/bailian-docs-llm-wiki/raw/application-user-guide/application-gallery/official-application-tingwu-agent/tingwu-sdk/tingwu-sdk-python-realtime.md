...
以[工业生产指令转写交互协议（WebSocket）](raw/application-user-guide/application-gallery/official-application-tingwu-agent/tingwu-industrial-instruction/tingwu-industrial-instruction-api/tingwu-industrial-instruction-api-websocket.md)为例，创建任务支持传入的主要参数如下：
