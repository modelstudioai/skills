# SubmitLongTextTranslateTask - 提交长文本翻译任务
...
[调试](https://api.alibabacloud.com/api/AnyTrans/2025-07-07/SubmitLongTextTranslateTask)
...
```
POST /anytrans/translate/longText/submit HTTP/1.1
```
