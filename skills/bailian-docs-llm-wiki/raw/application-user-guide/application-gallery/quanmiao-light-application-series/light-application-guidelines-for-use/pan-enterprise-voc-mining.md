...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3991694471/p944696.png) ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3991694471/p944697.png)
...
您也可以点击**添加自定义标签**或**批量输入**，添加筛选维度，具体操作请参见[设置内容标签](raw/application-user-guide/application-gallery/quanmiao-light-application-series/light-application-guidelines-for-use/pan-enterprise-voc-mining.md)。
