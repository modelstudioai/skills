...
点击**效果调试**页签，您可以参考以下步骤设置配置项。

#### 第一步：上传素材

1.  把待审核内容贴入文本框，可以是文章、评论等，可参考官方示例填写。
2.  选择线索的模型，默认为**千问-Max**。
...
-   按照格式输入**审核维度、审核标准**，支持单个或批量输入。可参考右侧官方提供的**示例**填写。
-   点击**批量输入**，可一键粘贴所有的审核维度、审核标准，自动识别。
-   点击**添加自定义维度**，可支持用户自定义新增维度，精准挖掘信息。
