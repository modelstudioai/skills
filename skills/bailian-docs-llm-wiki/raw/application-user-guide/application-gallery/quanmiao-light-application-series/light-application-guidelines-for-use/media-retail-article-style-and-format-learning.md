...
2.  输入需要学习的文章**。**
    ...
    在**文章样例**文本框中输入需要学习的文章，供大模型分析。您最多可添加10篇（单击**增加一篇**，在新增的**文章样例**文本框中输入需要学习的文章），总字数不超过4000字。
    
3.  测试学习效果。
    
    1.  在**写作主题**文本框中，输入写作的主题、内容或相关信息和要求，描述详细具体。
    2.  根据写作主题，您可以添加写作参考素材，为大模型写作指引创作方向。您最多可添加10篇（单击**增加一篇**，在新增的**参考素材**文本框中输入需要学习的文章），总字数不超过4000字。
4.  单击**创作**。
