...
[调试](https://api.aliyun.com/api/QuanMiaoLightApp/2024-08-01/SubmitVideoDetectShotTask)
...
```
POST /{workspaceId}/quanmiao/lightapp/submitVideoDetectShotTask HTTP/1.1
```
