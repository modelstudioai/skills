...
[调试](https://api.alibabacloud.com/api/QuanMiaoLightApp/2024-08-01/GetFileContent)
...
阿里云百炼平台[工作空间 ID](raw/application-api-reference/application-call/obtain-the-app-id-and-workspace-id.md)
