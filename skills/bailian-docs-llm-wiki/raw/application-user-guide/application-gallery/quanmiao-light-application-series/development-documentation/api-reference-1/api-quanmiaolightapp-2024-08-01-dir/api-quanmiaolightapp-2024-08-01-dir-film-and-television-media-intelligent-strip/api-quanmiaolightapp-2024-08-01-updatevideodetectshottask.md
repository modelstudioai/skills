# UpdateVideoDetectShotTask - 智能拆条-修改异步任务状态
...
[调试](https://api.alibabacloud.com/api/QuanMiaoLightApp/2024-08-01/UpdateVideoDetectShotTask)
...
```
PUT /{workspaceId}/quanmiao/lightapp/updateVideoDetectShotTask HTTP/1.1
```
