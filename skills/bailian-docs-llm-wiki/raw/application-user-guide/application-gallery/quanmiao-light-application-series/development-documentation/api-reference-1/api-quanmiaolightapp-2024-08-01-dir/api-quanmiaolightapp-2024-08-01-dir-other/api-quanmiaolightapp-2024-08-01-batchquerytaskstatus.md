...
[调试](https://api.aliyun.com/api/QuanMiaoLightApp/2024-08-01/BatchQueryTaskStatus)
...
```
POST /{workspaceId}/quanmiao/lightapp/batchQueryTaskStatus HTTP/1.1
```
...
任务状态(PENDING:待执行,RUNNING:执行中,SUCCESSED:成功,FAILED:失败,CANCELED:已取消,NOT\_FOUND:任务不存在)
