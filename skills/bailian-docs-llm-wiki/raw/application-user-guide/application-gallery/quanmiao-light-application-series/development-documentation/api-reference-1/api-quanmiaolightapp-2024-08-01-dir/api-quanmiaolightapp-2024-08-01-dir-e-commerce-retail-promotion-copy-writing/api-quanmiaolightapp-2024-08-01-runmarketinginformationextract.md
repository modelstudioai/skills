...
[调试](https://api.alibabacloud.com/api/QuanMiaoLightApp/2024-08-01/RunMarketingInformationExtract)
...
路径参数，[业务空间 id](raw/application-api-reference/application-call/obtain-the-app-id-and-workspace-id.md)
