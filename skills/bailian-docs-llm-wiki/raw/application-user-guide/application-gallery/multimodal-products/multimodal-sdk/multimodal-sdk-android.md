...
-   **EntranceActivity** 入口页面，需要修改url/api\_key/app\_id等信息。
    ...
    -   使用 License 模式，请参考子文档【[使用 License 模式接入Android SDK](raw/application-user-guide/application-gallery/multimodal-products/multimodal-sdk/multimodal-sdk-android/multimodal-license-android.md)】。
...
[RequestToSpeak](raw/application-user-guide/application-gallery/multimodal-products/multimodal-api-references/multimodal-interaction-protocol.md)消息打断
