...
本文介绍如何基于设备端C SDK实现视觉相关能力，如视频对话、拍照问答。

## 1\. 开发准备

### 1.1. 前置说明

-   本文依赖前置文档 “[基于设备端C SDK实现聊天能力](raw/application-user-guide/application-gallery/multimodal-products/multimodal-best-practices/rtos-c-sdk-best-practices/chat-capability-based-on-rtos-sdk.md)” ，请在阅读本文前先完成相关内容的学习与环境准备。
-   默认开发者已完成SDK接入，并可正常运行语音交互流程。
-   此最佳实践将会使用[基于设备端C SDK实现聊天能力](raw/application-user-guide/application-gallery/multimodal-products/multimodal-best-practices/rtos-c-sdk-best-practices/chat-capability-based-on-rtos-sdk.md)中的部分伪代码和交互流程。
...
获取SDK包可以参考文档：[设备端C SDK](raw/application-user-guide/application-gallery/multimodal-products/multimodal-sdk/mmi-rtos-sdk.md)
