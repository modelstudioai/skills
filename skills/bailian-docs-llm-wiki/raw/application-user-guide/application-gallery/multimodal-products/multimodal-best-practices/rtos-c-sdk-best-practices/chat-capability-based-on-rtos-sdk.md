...
参考[设备端C SDK](raw/application-user-guide/application-gallery/multimodal-products/multimodal-sdk/mmi-rtos-sdk.md)，根据芯片型号，下载相应的 SDK 包。

如采用半托管模式，需要根据[设备端C SDK](raw/application-user-guide/application-gallery/multimodal-products/multimodal-sdk/mmi-rtos-sdk.md)，完成服务端相关接口对接。
