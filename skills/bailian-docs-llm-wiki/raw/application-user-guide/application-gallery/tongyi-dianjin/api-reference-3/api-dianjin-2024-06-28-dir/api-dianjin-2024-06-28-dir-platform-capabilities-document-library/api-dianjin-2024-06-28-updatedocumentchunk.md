...
[调试](https://api.alibabacloud.com/api/DianJin/2024-06-28/UpdateDocumentChunk)
...
```
PUT /{workspaceId}/api/library/updateDocumentChunk HTTP/1.1
```
