# CreateAnnualDocSummaryTask - 创建按年份总结文档任务
...
[调试](https://api.alibabacloud.com/api/DianJin/2024-06-28/CreateAnnualDocSummaryTask)
...
```
POST /{workspaceId}/api/task/summary/doc/annual HTTP/1.1
```
