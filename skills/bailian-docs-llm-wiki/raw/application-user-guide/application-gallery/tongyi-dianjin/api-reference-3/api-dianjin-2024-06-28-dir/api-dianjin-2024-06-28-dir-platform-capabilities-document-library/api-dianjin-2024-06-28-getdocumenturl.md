...
[调试](https://api.alibabacloud.com/api/DianJin/2024-06-28/GetDocumentUrl)
...
```
GET /{workspaceId}/api/library/document/url HTTP/1.1
```
...
返回数据，为文档下载链接，链接过期时间为 1 小时。

https://path\_to\_file
