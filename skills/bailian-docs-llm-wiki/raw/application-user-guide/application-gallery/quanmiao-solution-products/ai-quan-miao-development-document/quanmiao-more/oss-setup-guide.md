...
**说明**妙搜默认使用其自有存储，启用OSS为可选增强能力，妙搜的使用指南请参考《[妙搜](raw/application-user-guide/application-gallery/quanmiao-solution-products/miaosou-and-miaodu/miaodou-and-miaodu-guidelines-for-use/ai-miaosou.md)》。
...
**说明**此步骤必须存在！全妙仅被授予该前缀下文件的读写权限（最小权限原则）。
...
`[https://aimiaobi.console.aliyun.com](https://aimiaobi.console.aliyun.com)`
