...
#### API：[系统配置-信源管理](raw/application-user-guide/application-gallery/quanmiao-solution-products/ai-quan-miao-development-document/amb-api-reference/api-aimiaobi-2023-08-01-dir/api-aimiaobi-2023-08-01-dir-system-configuration-source-management.md)
...
-   [妙搜-数据源](raw/application-user-guide/application-gallery/quanmiao-solution-products/ai-quan-miao-development-document/amb-api-reference/api-aimiaobi-2023-08-01-dir/api-aimiaobi-2023-08-01-dir-wonderful-search-data-source.md)：维护企业知识
...
-   [系统配置-信源管理](raw/application-user-guide/application-gallery/quanmiao-solution-products/ai-quan-miao-development-document/amb-api-reference/api-aimiaobi-2023-08-01-dir/api-aimiaobi-2023-08-01-dir-system-configuration-source-management.md)：配置信源，可以通过控制台配置
...
1.  准备三方企业搜索API：
    ...
    1.  按照推荐的API模板提供API（非标、或不支持的鉴权需要定开）：[三方搜索API规范](raw/application-user-guide/application-gallery/quanmiao-solution-products/ai-quan-miao-development-document/miaobi-and-miaoce-best-practices/best-practices-for-miaosou-api/third-party-search-api-template.md)。
2.  配置三方企业搜索API：
