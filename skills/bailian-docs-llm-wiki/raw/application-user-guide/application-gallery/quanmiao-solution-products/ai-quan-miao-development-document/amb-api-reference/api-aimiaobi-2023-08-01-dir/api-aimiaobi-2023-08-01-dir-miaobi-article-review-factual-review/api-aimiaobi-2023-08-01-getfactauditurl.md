...
[调试](https://api.alibabacloud.com/api/AiMiaoBi/2023-08-01/GetFactAuditUrl)
...
当前正用于事实性审核的信源 URL 列表。当列表中没有 URL 时，检索信源为全网；有 URL 时，只从配置好的 URL 中获取信息。删除不需要的信源 URL 时，请使用出参中的 URL 填写到 DeleteFactAuditUrl 接口的入参。
