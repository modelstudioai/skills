...
[调试](https://api.alibabacloud.com/api/AiMiaoBi/2023-08-01/SubmitSmartClipTask)
...
指定单个或多个口播音色（英文逗号分隔）。当指定多个 voice 时，会随机选取一个合成。音色的可选范围请参见[智能语音效果示例](https://help.aliyun.com/zh/ims/developer-reference/smart-voice-effect-example?spm=a2c4g.11186623.0.0.13091ee6Pw4Jqz)。例："zhimiao\_emo,zhilun"。
