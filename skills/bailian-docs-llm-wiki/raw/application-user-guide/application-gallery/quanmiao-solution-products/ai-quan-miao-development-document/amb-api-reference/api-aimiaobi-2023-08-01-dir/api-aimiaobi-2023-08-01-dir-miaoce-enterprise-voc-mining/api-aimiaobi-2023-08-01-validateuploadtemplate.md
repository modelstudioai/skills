# ValidateUploadTemplate - 校验VOC上传模板
...
[调试](https://api.alibabacloud.com/api/AiMiaoBi/2023-08-01/ValidateUploadTemplate)
...
模板类型（Content：表示内容素材模板校验，PositiveSample：正面样本）
