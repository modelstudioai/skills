...
[调试](https://api.alibabacloud.com/api/AiMiaoBi/2023-08-01/RunCommentGeneration)
...
路径参数，阿里云百炼业务空间唯一标识：获取[业务空间 ID（Workspace ID）](raw/application-api-reference/application-call/obtain-the-app-id-and-workspace-id.md)
