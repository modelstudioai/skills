...
**说明**Prompt样例库功能已不再维护，推荐您将样例库数据迁移到 RAG 表格库中，参见[Prompt 样例库迁移到 RAG 表格库](https://help.aliyun.com/zh/model-studio/migrate-sample-library-prompt-to-rag-table-library)。
