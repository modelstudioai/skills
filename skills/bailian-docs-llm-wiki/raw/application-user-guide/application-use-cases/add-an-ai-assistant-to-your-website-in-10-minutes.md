...
> 阿里云百炼提供的[新用户免费额度](https://help.aliyun.com/zh/model-studio/new-free-quota)可以覆盖本教程的模型调用消耗，额度消耗完后按 token 计费，相比自行部署大模型可以显著降低初期投入成本。本教程中使用的 AppFlow、函数计算 FC 及可选的 ADB-PG 向量存储由相应云产品单独计费，具体请参见各产品的计费文档。
