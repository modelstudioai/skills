...
-   **方式二**：访问[**应用管理**](https://bailian.console.aliyun.com/#/app-center)页面，在指定智能体或工作流应用内，添加指定插件，测试插件使用效果，并**发布**应用。具体操作请参见[智能体应用插件能力](https://help.aliyun.com/zh/model-studio/single-agent-application#550c6b3ddevkl)、[工作流应用插件节点](raw/application-user-guide/llm-application/workflow-application.md)。
