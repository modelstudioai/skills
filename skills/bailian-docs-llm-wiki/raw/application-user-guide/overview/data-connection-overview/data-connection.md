...
**说明**本页介绍的是旧版数据连接。新版 Connector 已上线，支持连接更多系统，并可通过 MCP 供智能体调用，详见 [Connector 概述](raw/application-user-guide/overview.md)。旧版数据连接需在 **2026 年 9 月 30 日**前完成迁移，操作步骤见[数据连接迁移](raw/application-user-guide/overview/overview/migration.md)。
