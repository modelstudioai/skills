...
5.  **启用“多轮对话改写”**：根据历史对话自动补全用户查询，确保大模型能正确理解多轮对话中的指代和上下文省略。
    ...
    **说明：多轮对话改写**
    ...
    ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3562168571/p1008316.png)
...
3.  **必要时新增或删除单条切片：**除修正现有切片外，您还可以直接在切片层做更细粒度的管理，应对智能切分无法覆盖的边界情况。
    ...
    **说明**
    ...
    不同知识库类型支持的切片操作存在差异：**编辑切片（更新内容）所有类型的知识库均支持**，在切片详情弹窗右上角单击编辑即可操作。新增和删除方面，文档搜索类、数据查询类、图片问答类知识库均支持；**音视频搜索类知识库仅支持删除切片**。
...
2.  **提高“召回片段数”：**对于需要总结、列举或比较的复杂问题，适当增加该值有助于大模型生成更完整的答案。
    ...
    **说明：提高召回片段数**
    ...
    ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3188584871/CAEQURiBgMCatMinohkiIDY3YTVhOWY2MjNjMjRkYzc5NTU1ZmVhNGQ2MGQ5ODc24762899_20250109142407.621.svg)
...
在知识检索或知识问答的配置页中，点击知识库旁的![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6339082871/p1080483.png)图标可展开独立检索参数，针对不同知识库进行精细化调优：
