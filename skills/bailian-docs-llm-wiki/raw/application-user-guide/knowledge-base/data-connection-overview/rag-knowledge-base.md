...
![知识库类型与使用场景选择](https://img.alicdn.com/imgextra/i2/O1CN01QYqzSp1XWS1AStRCA_!!6000000002931-2-tps-2534-1516.png)

上方选择知识库类型，选中**文档搜索**后下方展示四种使用场景；其他类型无需选择场景。
...
5.  **配置索引设置**：
    ...
    ![索引设置](https://img.alicdn.com/imgextra/i3/O1CN01wHTl0h25lkB99sbcJ_!!6000000007567-2-tps-2084-1188.png)
