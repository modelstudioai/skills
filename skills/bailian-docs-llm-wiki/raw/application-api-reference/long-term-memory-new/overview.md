...
`Bearer $DASHSCOPE_API_KEY`，获取方式见[鉴权](raw/application-api-reference/long-term-memory-new/overview/authentication.md)
...
排查问题时，请提供 `request_id`，以便技术支持快速定位。完整错误码见[错误码参考](raw/application-api-reference/long-term-memory-new/overview/errors.md)。
...
**说明**记忆库将于 **2026 年 8 月 20 日** 正式商业化计费。Add 和 Search 调用区分 **Pro** 和 **Lite** 两个策略版本。详见[计费说明](raw/application-user-guide/memory-library-overview/overview/billing.md)。
