...
`Bearer $DASHSCOPE_API_KEY`，获取方式见[**鉴权**](raw/application-api-reference/overview/authentication.md)
...
-   [提交解析任务](raw/application-api-reference/overview/document-parsing/parse-submit.md)：提交文档或音视频解析任务，返回 biz\_id 用于异步查询。
-   [提交抽取任务](raw/application-api-reference/overview/field-extraction/extract-submit.md)：按 JSON Schema 提交结构化信息抽取任务。
-   [错误码](raw/application-api-reference/overview/errors.md)：查看错误响应格式与公开错误码。
