...
[调试](https://api.aliyun.com/api/bailian/2023-12-29/GetParseSettings)
...
类目 ID，即 **AddCategory** 接口返回的`CategoryId`，或者在[应用数据](https://bailian.console.aliyun.com/cn-beijing/?tab=app#/data-center)\-非结构化数据页签，单击类目名称旁的 ID 图标获取。
