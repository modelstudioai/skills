...
[调试](https://api.aliyun.com/api/bailian/2023-12-29/ListChunks)
...
文件 ID，即 **AddFile** 接口返回的`FileId`。数据查询/图片问答类知识库不用传入此字段；文档搜索类知识库必须传入此字段。您也可以在 [应用数据](https://bailian.console.aliyun.com/cn-beijing/?tab=app#/data-center)\-文件页签，单击文件名称旁的 ID 图标获取。可以通过文件 ID 筛选返回的切片。默认值为空。
