...
[调试](https://api.aliyun.com/api/bailian/2023-12-29/DeleteIndexDocument)
...
文件 ID，即 **AddFile** 接口返回的`FileId`。您也可以在[应用数据](https://bailian.console.aliyun.com/cn-beijing/?tab=app#/data-center)\-文件页签，单击文件名称旁的 ID 图标获取。
