...
[安全存储空间](raw/model-user-guide/security-and-compliance/secure-storage.md)通过此服务关联角色访问您在[OSS](https://help.aliyun.com/zh/oss/user-guide/what-is-oss)中的资源。
...
[模型调优](raw/model-user-guide/fine-tuning.md)和[数据管理](https://help.aliyun.com/zh/model-studio/manage-data)使用此服务关联角色访问您在[CPFS](https://help.aliyun.com/zh/cpfs/cpfs-product-introduction)和[OSS](https://help.aliyun.com/zh/oss/user-guide/what-is-oss)中的资源。
...
百炼[安全存储空间](raw/model-user-guide/security-and-compliance/secure-storage.md)通过此服务关联角色访问您在[OSS](https://help.aliyun.com/zh/oss/user-guide/what-is-oss)中的资源。
...
百炼[安全存储空间](raw/model-user-guide/security-and-compliance/secure-storage.md)通过此服务关联角色访问您的 [ADB-PG](https://help.aliyun.com/zh/analyticdb/analyticdb-for-postgresql/product-overview/overview-product-overview) 数据库实例。
...
阿里云百炼[模型调优](raw/model-user-guide/fine-tuning.md)和[数据管理](https://help.aliyun.com/zh/model-studio/manage-data)通过此服务关联角色访问您在[CPFS](https://help.aliyun.com/zh/cpfs/cpfs-product-introduction)和[OSS](https://help.aliyun.com/zh/oss/user-guide/what-is-oss)中的资源。
