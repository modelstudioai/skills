...
若尚未完成 OSS 授权，确定按钮不可用，须先完成[首次导入前完成 OSS 授权](https://help.aliyun.com/zh/model-studio/model-import#h2-authorize-oss)后再提交。导入成功后即可部署，部署操作详见[部署运维](raw/model-user-guide/model-deployment-1/model-import.md)。
