...
-   [万相-文生图V1](raw/model-api-reference/image-generation/wan-image-api-reference/text-to-image-api-reference.md)
...
-   **镜头语言：**镜头语言包含景别、视角等，常见镜头语言详见[提示词词典](https://help.aliyun.com/zh/model-studio/text-to-image-prompt#f5ca17bc46vw0)。
    
-   **氛围词：**氛围词是对预期画面氛围的描述，例如“梦幻”、“孤独”、“宏伟”，常见氛围词详见[提示词词典](https://help.aliyun.com/zh/model-studio/text-to-image-prompt#f5ca17bc46vw0)。
