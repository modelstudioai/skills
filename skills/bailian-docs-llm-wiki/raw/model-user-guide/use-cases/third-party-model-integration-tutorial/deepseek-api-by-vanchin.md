...
1.  前往[百炼控制台](https://bailian.console.aliyun.com/cn-beijing/model/market)，搜索 vanchin/deepseek，找到 DeepSeek 模型卡片，单击立即开通；
2.  在弹窗内确认开通及授权。
...
-   Base64 编码：将图像文件转换为 Base64 编码字符串，详情请参见[Base64 编码上传](raw/model-user-guide/model-experience/vision-model/qwen-vl-ocr.md)。
...
[Function Calling](raw/model-user-guide/model-experience/text-generation-model/tool-calls/qwen-function-calling.md)
