...
`qwen-omni-turbo`模型的推理服务供应商为阿里云百炼。
...
`qwen-omni-turbo-latest`模型的推理服务供应商为阿里云百炼。
...
`qwen-omni-turbo-2025-03-26`模型的推理服务供应商为阿里云百炼。
...
`qwen-omni-turbo-2025-01-19`模型的推理服务供应商为阿里云百炼。
