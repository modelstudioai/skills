...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3753415871/CAEQZhiBgMDg9PGS2hkiIDNlZDFiMGRlMTJhOTQ1YzJhMmNjNDM3NzQ1ZjNiOGZk4608430_20240830103738.564.svg)
...
如果您缺乏数据，建议构建[智能体应用（Agent 1.0）](https://help.aliyun.com/zh/model-studio/single-agent-application)，使用知识库索引来增强模型能力。当然在很多复杂的业务场景，可以综合采用模型调优和知识库检索结合的技术方案。
