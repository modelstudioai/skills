...
需先购买 Token Plan 个人版套餐且套餐处于有效期内。可在[Token Plan 个人版页面](https://bailian.console.aliyun.com/cn-beijing/subscription/overview)购买套餐。
...
需先购买 Token Plan 团队版套餐且套餐处于有效期内。可在[Token Plan 团队版页面](https://bailian.console.aliyun.com/subscription/overview)购买套餐。
...
-   美国（弗吉尼亚）：`https://{WorkspaceId}.us-east-1.maas.aliyuncs.com/apps/anthropic/v1`
...
如需添加[其他模型](raw/model-api-reference/qwen-api-reference/anthropic-api-messages.md)，在 `models` 中以相同格式追加即可。
...
-   按量付费：[Anthropic API 兼容 - 错误码](raw/model-api-reference/qwen-api-reference/anthropic-api-messages.md)
