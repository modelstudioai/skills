...
将 YOUR\_API\_KEY 替换为[阿里云百炼API Key](raw/model-api-reference/preparations/get-api-key.md)。可用模型参见[Anthropic 兼容 API](https://help.aliyun.com/zh/model-studio/anthropic-api-messages)。
...
-   按量计费：[Anthropic API兼容 - 错误码](https://help.aliyun.com/zh/model-studio/anthropic-api-messages)
