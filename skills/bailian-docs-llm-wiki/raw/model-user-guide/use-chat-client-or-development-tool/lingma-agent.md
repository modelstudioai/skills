...
2.  模型配置信息如下：
    ...
    **说明**
    ...
    -   Token Plan 个人版：[获取 API Key](https://bailian.console.aliyun.com/cn-beijing/subscription/token-plan/personal)
        
    -   Token Plan 团队版：[获取 API Key](https://bailian.console.aliyun.com/cn-beijing/subscription/token-plan/enterprise)
        
    -   Coding Plan：[获取 API Key](https://bailian.console.aliyun.com/cn-beijing/subscription/coding-plan)
...
-   **选用了套餐不支持的模型**：仅支持当前套餐覆盖的文本生成模型。例如，Token Plan 团队版的支持模型列表可在[Token Plan 团队版页面](https://bailian.console.aliyun.com/subscription/token-plan/enterprise)查看。
-   **临时网络或服务波动**：稍后重试。
