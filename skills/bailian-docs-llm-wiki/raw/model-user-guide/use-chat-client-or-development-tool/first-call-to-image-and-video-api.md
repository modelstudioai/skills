...
**说明**Postman 和 cURL仅适用于快速测试与功能验证。对于生产环境，建议您使用官方 SDK 或自行实现 HTTP 调用。
...
**HTTP调用示例（文生图）** ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7834246871/CAEQZRiBgICJ0seH1xkiIDgzYWE2MTBkZjkzODRkNDA5NzczNTE0NjBiMGE1Y2Nm5274221_20250627113930.173.svg)
...
在调用API之前，您需要[根据地域获取API Key](raw/model-api-reference/preparations/get-api-key.md)，下载[Postman](https://www.postman.com/downloads/)到本地。
...
-   已[开通模型服务并获取API Key](raw/model-api-reference/preparations/get-api-key.md)。
...
-   **深入了解API参数**：查看[文生图API](raw/model-api-reference/image-generation/wan-image-api-reference/text-to-image-v2-api-reference.md)，了解更多输入输出参数。
    
-   **体验视频生成**：调用[首帧生视频API](raw/model-api-reference/image-generation/wan-image-api-reference/text-to-image-v2-api-reference.md)，体验动态视频创作。
