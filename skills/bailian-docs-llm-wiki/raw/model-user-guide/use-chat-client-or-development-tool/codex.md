...
`model`请选择[支持的模型](raw/model-user-guide/token-plan-guide/token-plan-personal/token-plan-personal-overview.md)。将`OPENAI_API_KEY`环境变量设置为 Token Plan 个人版专属 [API Key](https://bailian.console.aliyun.com/cn-beijing/subscription/overview)。
...
若所选模型支持 [OpenAI Responses API](raw/model-api-reference/qwen-api-reference/openai-compatible-responses/qwen-api-via-openai-responses.md)，可使用最新版 Codex。
...
然后配置模型元数据，以便在模型间切换。新建 `~/.codex/model-catalog.local.json`，写入该套餐支持的模型：
...
```
{
  "models": [
    ...
    },
    {
      ...
      "description": "DashScope model: qwen3.8-flash",
      "default_reasoning_level": "xhigh",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: qwen3.7-max",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: qwen3.7-plus",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: qwen3.6-flash",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: deepseek-v4.1-flash",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: deepseek-v4-pro",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: deepseek-v4-pro-0813",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: deepseek-v4-flash-0731",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
...
在 `~/.codex/config.toml` 中添加以下配置指向该文件：
...
`model`请选择[支持的模型](raw/model-user-guide/token-plan-guide/token-plan-overview.md)。将`OPENAI_API_KEY`环境变量设置为 Token Plan 团队版专属 [API Key](https://bailian.console.aliyun.com/cn-beijing/subscription/uac-admin/organization/members/list)。
...
```
{
  "models": [
    ...
    },
    {
      ...
      "description": "DashScope model: qwen3.6-plus",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: deepseek-v4-flash",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: deepseek-v3.2",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: kimi-k2.7-code",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: kimi-k2.6",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: kimi-k2.5",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: glm-5.1",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      "slug": "glm-5",
      "display_name": "glm-5",
      "description": "DashScope model: glm-5",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
    ...
    },
    {
      ...
      "description": "DashScope model: MiniMax-M2.5",
      "default_reasoning_level": "medium",
      "supported_reasoning_levels": [
        {
          "effort": "low",
...
`model`请选择[支持的模型](raw/model-user-guide/token-plan-guide/coding-plan-guide/coding-plan.md)。将`OPENAI_API_KEY`环境变量设置为 Coding Plan 专属 [API Key](https://bailian.console.aliyun.com/cn-beijing/subscription/coding-plan)。
...
Coding Plan 仅支持 Chat/Completions API，配置如下：
...
Coding Plan 不支持 Responses API（仅 Chat/Completions API），因此不配置多模型元数据；如需在模型间切换，请改用 Token Plan 或按量计费的 Responses API 接入。
...
将`OPENAI_API_KEY`环境变量设置为[百炼 API Key](raw/model-api-reference/preparations/get-api-key.md)。
...
适用于支持 [OpenAI Responses API](raw/model-api-reference/qwen-api-reference/openai-compatible-responses/qwen-api-via-openai-responses.md) 的模型（如 qwen3.7-max），可使用最新版 Codex。
...
1.  在 CC Switch 主界面顶部图标栏选中 Codex 图标，点击右上角 **+** 进入**添加新供应商**，按下表填入配置后点击**添加**。
    ...
    **配置信息**
    ...
    API Key：[控制台获取](https://bailian.console.aliyun.com/cn-beijing/subscription/overview)
    
    请求地址：`[https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1](https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1)`
    
    Token Plan 团队版
    
    供应商名称：百炼-Token Plan 团队版
    
    API Key：[控制台获取](https://bailian.console.aliyun.com/cn-beijing/subscription/uac-admin/organization/members/list)
    ...
    API Key：[控制台获取](https://bailian.console.aliyun.com/cn-beijing/subscription/coding-plan)
    
    请求地址：`[https://coding.dashscope.aliyuncs.com/v1](https://coding.dashscope.aliyuncs.com/v1)`
    
    按量计费
    
    供应商名称：百炼-按量计费
    
    API Key：[百炼 API Key](raw/model-api-reference/preparations/get-api-key.md)
    
    请求地址：`https://{WorkspaceId}.cn-beijing.maas.aliyuncs.com/compatible-mode/v1`
    
2.  展开**高级选项**填写模型名称，从对应套餐[支持的模型](raw/model-user-guide/token-plan-guide/token-plan-overview.md)中选择，例如 `qwen3.7-max`（Coding Plan 不支持）。
...
**说明**：百炼支持通过 Codex 使用中国内地模型，配置方式详见上文[配置接入凭证](https://help.aliyun.com/zh/model-studio/codex#cdx-config-h)。

**解决方案**：建议参照上文配置接入凭证，直接在`~/.codex/config.toml`中完成配置，无需依赖第三方工具的健康检查结果；配置完成后参照[验证配置](https://help.aliyun.com/zh/model-studio/codex#cdx-verify-h)启动 Codex，若能正常进入对话界面即表示可正常使用中国内地模型。
...
-   报错 `wire_api = "chat" is no longer supported`：将配置文件中的 `wire_api` 改为 `responses`，并确认 `base_url` 配置正确。详见上文[配置接入凭证](https://help.aliyun.com/zh/model-studio/codex#cdx-config-h)中对应方案的配置示例。
...
**解决方案**：确认`base_url`和`wire_api`与所选方案的配置一致。参见上文[配置接入凭证](https://help.aliyun.com/zh/model-studio/codex#cdx-config-h)中对应方案的配置示例。
