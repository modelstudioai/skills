...
**说明**Token Plan 目前仅支持**华北2（北京）**地域，请在[百炼控制台](https://bailian.console.aliyun.com/cn-beijing/subscription/token-plan)左上角将地域切换至**华北2（北京）**后购买并使用。
...
支持多种模型内置工具，以 Credits 统一抵扣（[查看详情](https://help.aliyun.com/zh/model-studio/token-plan-personal-overview#tpp01-h-harness)）

**Harness 权益**

Standard 与 Pro 套餐附赠 AgentStudio 工具免费额度与折扣，不占 Credits（[查看详情](raw/model-user-guide/token-plan-guide/token-plan-personal/token-plan-harness-benefits.md)）
...
支持多种模型内置工具，以 Credits 统一抵扣（[查看详情](https://help.aliyun.com/zh/model-studio/token-plan-team-quickstart#tpt02-h-optional-tool)）
