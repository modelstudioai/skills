...
在调用前，[开通Tripo模型服务](https://bailian.console.aliyun.com/cn-beijing/model/market)，并[获取与配置 API Key](raw/model-api-reference/preparations/get-api-key.md)，再[配置API Key到环境变量](https://help.aliyun.com/zh/model-studio/configure-api-key-through-environment-variables)。
