...
支持指令控制的模型：Qwen-Audio-TTS 系列（`qwen-audio-3.0-tts-plus`、`qwen-audio-3.0-tts-flash`）、CosyVoice 系列（`cosyvoice-v3.5-plus`、`cosyvoice-v3.5-flash`、`cosyvoice-v3-flash`）和 Qwen-TTS 系列（`qwen3-tts-instruct-flash-realtime`、`qwen3-tts-instruct-flash-realtime-2026-01-22`、`qwen3-tts-instruct-flash`、`qwen3-tts-instruct-flash-2026-01-26`）。详细使用方式请参见[实时语音合成 > 指令控制](https://help.aliyun.com/zh/model-studio/realtime-tts-user-guide)。
