...
![robot](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6710872271/p824100.png) [构建智能客服](raw/application-user-guide/llm-application/single-agent-application.md)

通过可视化工具快速搭建 AI 助手，处理客户咨询。

![智能客服示例](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6710872271/p823451.gif)

![process](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6710872271/p824091.png) [编排流程](raw/application-user-guide/llm-application/workflow-application.md)

可视化流程编排，无代码基础的业务人员也能独立完成工作流设计。

![流程\_4](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6710872271/p824085.png)

![tune\_8](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6710872271/p824102.png) [微调模型](raw/model-user-guide/fine-tuning/fine-tune-text-generation-model/model-training-overview.md)
...
百炼提供开箱即用的模型服务，无需自行部署或运维，直接调用自研千问（Qwen）全系列模型，以及 DeepSeek、Kimi、GLM 等第三方大模型。详情请参见[选择模型](raw/model-user-guide/get-started-with-models/models.md)。
...
开通百炼无需费用，调用、微调、部署模型时产生相应费用，详情请参见[计费项](raw/model-user-guide/test-1/model-pricing.md)。
...
详见[新人免费额度](raw/model-user-guide/test-1/new-free-quota.md)。
...
-   发起第一个API请求：[首次调用千问API](raw/model-user-guide/get-started-with-models/first-api-call-to-qwen.md)
-   构建第一个大模型应用：[0代码构建问答应用](raw/application-user-guide/start-using/build-knowledge-base-qa-assistant-without-coding.md)

## 常见问题

Q：我的数据安全吗？阿里云百炼会用我的数据进行训练吗？

A：阿里云严格保护数据隐私，使用百炼按量付费 API 和 Token Plan 团队版时，不会将您的数据用于模型训练。构建应用或训练模型时传输的所有数据均经过加密处理。详情请参见[合规资质与隐私说明](raw/model-user-guide/security-and-compliance/privacy-notice.md)。

**重要****Token Plan 个人版**和 **Coding Plan** 的数据使用条款与上述承诺不同。使用 Coding Plan 期间，模型输入及模型生成的内容将用于服务改进与模型优化；Token Plan 个人版不包含团队版的"不使用数据训练模型"承诺。具体条款请参见[Token Plan 概述](raw/model-user-guide/token-plan-guide/token-plan-overview.md)和[Coding Plan概述](raw/model-user-guide/token-plan-guide/coding-plan-guide/coding-plan.md)，以及[《阿里云百炼服务协议》](https://terms.alicdn.com/legal-agreement/terms/common_platform_service/20230728213935489/20230728213935489.html)第 5.2 条。

Q：阿里云百炼提供哪些地域的服务？不同地域有什么区别？

A：目前提供以下地域的模型服务：

[华北2（北京）](https://bailian.console.aliyun.com/model/market)、[美国（弗吉尼亚）](https://bailian.console.aliyun.com/us-east-1)、[新加坡](https://bailian.console.aliyun.com/model/market)、[德国（法兰克福）](https://bailian.console.aliyun.com/eu-central-1)、[日本（东京）](https://bailian.console.aliyun.com/ap-northeast-1)和[中国香港](https://bailian.console.aliyun.com/cn-hongkong)地域

建议选择邻近地域以降低网络延迟。各地域的接入点（Endpoint/Base URL）不同，API Key 不通用，支持的模型、平台功能与价格也有所差异，详情请参见[选择模型](raw/model-user-guide/get-started-with-models/models.md)。
