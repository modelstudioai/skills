...
全妙产品支持 iframe 嵌入 具体请参考文档： [客户对接\_全妙公有云 iframe 定制方案](raw/_short/iframe-embedding-scheme-bca461d7147e8089.md)
...
写作文体，具体文体列表请参考： [ListWritingStyles](raw/_short/api-aimiaobi-2023-08-01-listwritingstyles-52bccb929c9fee6e.md)
...
2.  当 PromptMode=Template 时，需要传 WritingParams（字典类型，key、value 都是字符串），writingParams 表单定义参考： [ListWritingStyles](raw/_short/api-aimiaobi-2023-08-01-listwritingstyles-52bccb929c9fee6e.md) 接口中的 .Data.TemplateDefine\[\].Fields
...
[WritingOutline](raw/_short/api-aimiaobi-2023-08-01-struct-writingoutline-6738ed17a6be03d0.md)
...
[OutlineSearchResult](raw/_short/api-aimiaobi-2023-08-01-struct-outlinesearchresu-3e821dbd6fe7dbc6.md)

检索结果（分步骤大纲生成场景下 writingStyle=outlineWriting。step=OutlineSearch 时返回该字段）

GenerateTraceability

[GenerateTraceability](raw/_short/api-aimiaobi-2023-08-01-struct-generatetraceabil-1422819028102712.md)
