...
-   **前置条件**：使用[创建World](raw/_short/happyoyster-adventure-create-world-api-reference-b764ec539142394b.md)接口返回的 `encryptedWorldId` 查询。构建进度轮询应使用[查询World构建状态](raw/_short/happyoyster-adventure-query-world-build-status-a-4830e59b84023226.md)。
...
当前主账号名下的 Adventure 加密 World ID。由[创建World](raw/_short/happyoyster-adventure-create-world-api-reference-b764ec539142394b.md)接口返回。
...
-   [查询World列表](raw/_short/happyoyster-adventure-query-world-list-api-refer-67fcfc6f24ad12e2.md)：分页查询所有 Adventure World。
-   [删除World](raw/_short/happyoyster-adventure-delete-world-api-reference-55040f62da8f233e.md)：删除不再使用的 World。
-   World 为 `ready` 时可[获取体验凭证](raw/_short/happyoyster-adventure-get-travel-credential-api--d269f4908c7288f2.md)。
