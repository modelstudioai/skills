...
-   进入热词组管理的路径：
    ...
    -   路径1：进入[**伶鹊CCAI-对话分析AIO**](https://bailian.console.aliyun.com/?tab=app#/app/app-market/ccai)后，点击我的应用，可在界面中看到**热词组管理**按钮。
        
    -   路径2：通过进入具体应用的配置页面，点击**选择热词组**时进行添加对应的热词组。
        
        **说明**目前热词组支持通过自定义创建的应用；通过Agent创建的应用，需在‘专业构建模式’下才能找到并配置热词组。
...
1.  选择对应的热词组![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4669763871/p1086545.png)
2.  选择完成后可以查看绑定情况![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4669763871/p1086546.png)
