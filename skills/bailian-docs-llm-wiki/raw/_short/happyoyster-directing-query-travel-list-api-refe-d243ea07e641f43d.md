...
-   未知 `status` 不会报错，而是按不筛选状态处理；服务端暂停状态请通过[查询Travel状态](raw/_short/happyoyster-directing-query-travel-status-api-re-d536083e25c2aee5.md)查询单个 Travel。
...
-   [查询Travel状态](raw/_short/happyoyster-directing-query-travel-status-api-re-d536083e25c2aee5.md)：查询单个 Travel 的实时状态。
-   [查询Travel产物](raw/_short/happyoyster-directing-query-travel-artifacts-api-2da27b6ffc227186.md)：查询已完成 Travel 的视频产物。
