...
官方音色也可以参考官方文档：[支持的音色](https://help.aliyun.com/zh/model-studio/realtime-tts-user-guide#bac280ddf5a1u)，sambert支持的音色参考[Sambert音色列表](raw/_short/sambert-java-sdk-2155fade7e0c42a0.md)（去掉开头的"sambert-"和末尾的"-v1"后就是voice的取值）。
...
参数说明参考下方 [parameters.upstream的参数说明](raw/_short/multimodal-interaction-protocol-8062cfbb96fec75a.md)表格
...
参数说明参考下方 [parameters.downstream的参数说明](raw/_short/multimodal-interaction-protocol-8062cfbb96fec75a.md)表格
...
参数说明参考下方 [parameters.client\_info的参数说明](raw/_short/multimodal-interaction-protocol-8062cfbb96fec75a.md)表格
...
参数说明参考下方 [parameters.biz\_params的参数说明](raw/_short/multimodal-interaction-protocol-8062cfbb96fec75a.md)表格
