...
-   **前置条件**：使用[创建World](raw/_short/happyoyster-directing-create-world-api-reference-6f3bdbbb6537960b.md)接口返回的 `encryptedWorldId` 删除。
...
要删除的 Directing 加密 World ID。由[创建World](raw/_short/happyoyster-directing-create-world-api-reference-6f3bdbbb6537960b.md)接口返回。
...
-   [查询World列表](raw/_short/happyoyster-directing-query-world-list-api-refer-77a7187e20e73d36.md)：查看剩余 Directing World。
-   [创建World](raw/_short/happyoyster-directing-create-world-api-reference-6f3bdbbb6537960b.md)：创建新的 Directing World。
