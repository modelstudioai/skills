# CancelDatasourceAuthorization - 取消数据源关联关系授权
...
[调试](https://api.aliyun.com/api/DataAnalysisGBI/2024-08-23/CancelDatasourceAuthorization)
...
```
POST /gbi/cancel/datasource HTTP/1.1
```
...
当 success 为 true 时，errorMsg 和 code 应为空字符串 ""。
