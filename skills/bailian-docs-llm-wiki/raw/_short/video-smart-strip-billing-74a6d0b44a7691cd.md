...
-   技术文档
    ...
    可点击[视频智能拆条接口文档](raw/_short/api-quanmiaolightapp-2024-08-01-dir-film-and-tel-fc82739a928d6150.md)进行查看；
...
可以通过[智能拆条-获取配置](raw/_short/api-quanmiaolightapp-2024-08-01-getvideodetectsh-9a38892e8a07709c.md)、[智能拆条-更新配置](raw/_short/api-quanmiaolightapp-2024-08-01-updatevideodetec-2ccdb05cdd837629.md)接口查看和扩缩并发。
