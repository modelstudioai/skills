...
#### [获取PPT组件配置](raw/_short/api-aimiaobi-2023-08-01-getpptconfig-52f53c774cb5add0.md) -- 获取编辑PPT作品所需的code信息
...
#### [初始化PPT创建操作](raw/_short/api-aimiaobi-2023-08-01-initiatepptcreationv2-4062493b702b42ec.md)\-- 获取生成PPT过程中所需参数
...
通过[初始化PPT创建操作](raw/_short/api-aimiaobi-2023-08-01-initiatepptcreationv2-4062493b702b42ec.md)接口初始化创建PPT的会话，如下为示例代码：
...
可以通过[查询企业专属PPT模板列表](raw/_short/api-aimiaobi-2023-08-01-listenterpriseppttemplat-11fb38dc423d3cdc.md)获取测试模板，试用当前场景效果
...
用户根据exportTaskId调用 [查询PPT导出任务的结果](raw/_short/api-aimiaobi-2023-08-01-getpptartifactexportresu-37a0f7509007c9b8.md)进行轮询，获取PPT文件的下载地址。
