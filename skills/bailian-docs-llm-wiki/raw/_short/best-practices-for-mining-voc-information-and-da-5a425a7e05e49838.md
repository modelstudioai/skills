...
基于全妙泛企业VOC挖掘的接口[妙策-企业VOC挖掘](raw/_short/api-aimiaobi-2023-08-01-dir-miaoce-enterprise-vo-8c17c595bdcef002.md)（例如：本示例中的`SubmitEnterpriseVocAnalysisTask`接口），来帮您实现对已有工单类数据的Voc挖掘、标签提取。
...
可以采用析言GBI云服务所提供的[Chat对话接口](raw/_short/api-dataanalysisgbi-2024-08-23-rundataanalysis-697fa2953fc095a1.md)来实现如图所示的chatbi能力，并集成到自己的业务系统。
