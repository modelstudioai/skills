...
-   当前接口为 HTTP-SSE 协议。
-   由于 OpenAPI 门户目前对 SSE 推理协议不兼容（无法直接调试），接口 SDK 方式调用示例（支持 Java、Python 版本的 sdk）请参考 [PPT 生成最佳实践文档](raw/_short/ppt-generation-best-practices-4e71e43f3c7f3f66.md)。
