...
-   关于各API的详细出入参说明，请参见[API目录](raw/_short/api-contactcenterai-2024-06-03-dir-cddf1f9f75e718fa.md)。
-   关于任务类型，请参见[通过任务类型调用伶鹊CCAI-对话分析AIO应用](raw/_short/api-contactcenterai-2024-06-03-analyzeconversati-2f070271a7fbc375.md)中resultTypes字段的描述。
