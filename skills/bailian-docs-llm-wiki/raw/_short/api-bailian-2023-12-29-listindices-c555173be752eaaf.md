...
是否参与知识库检索。**true** 表示允许知识库在此列数据中进行搜索
...
是否参与模型回复。**true** 表示本列的检索结果将作为大模型生成回答时的输入信息
...
更多信息，参考[变更详情](https://api.aliyun.com/document/bailian/2023-12-29/ListIndices#workbench-doc-change-demo)。
