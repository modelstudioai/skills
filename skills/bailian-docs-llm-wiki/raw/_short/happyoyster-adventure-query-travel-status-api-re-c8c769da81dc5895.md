...
-   **前置条件**：使用[客户端进入房间](raw/_short/happyoyster-adventure-enter-travel-api-reference-3eb107188008bbaf.md)接口返回的 `encryptedTravelId` 查询。
...
Adventure 加密 Travel ID。由[客户端进入房间](raw/_short/happyoyster-adventure-enter-travel-api-reference-3eb107188008bbaf.md)接口返回。
...
-   本接口不返回 `mode`、`playUrl`、`bgmUrl` 或 `sessionId`；播流配置以[进入房间](raw/_short/happyoyster-adventure-enter-travel-api-reference-3eb107188008bbaf.md)响应为准。
