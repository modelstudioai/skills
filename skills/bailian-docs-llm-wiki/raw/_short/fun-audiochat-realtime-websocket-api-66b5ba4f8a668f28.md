...
**用户指南**：[实时语音对话（Qwen-Audio-Realtime）](https://help.aliyun.com/zh/model-studio/fun-audiochat-realtime)。客户端事件和服务端事件的详细说明，请参见[客户端事件](raw/_short/fun-audiochat-client-events-613371219df1f107.md)和[服务端事件](raw/_short/qwen-audio-realtime-server-events-570d84e54a56325a.md)。
