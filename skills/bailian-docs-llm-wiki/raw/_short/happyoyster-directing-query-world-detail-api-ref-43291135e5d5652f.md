...
-   **前置条件**：使用[创建World](raw/_short/happyoyster-directing-create-world-api-reference-6f3bdbbb6537960b.md)接口返回的 `encryptedWorldId` 查询。构建进度轮询应使用[查询World构建状态](raw/_short/happyoyster-directing-query-world-build-status-a-48bf75e27c43945d.md)。
...
当前主账号名下的 Directing 加密 World ID。由[创建World](raw/_short/happyoyster-directing-create-world-api-reference-6f3bdbbb6537960b.md)接口返回。
...
-   [查询World列表](raw/_short/happyoyster-directing-query-world-list-api-refer-77a7187e20e73d36.md)：分页查询所有 Directing World。
-   [删除World](raw/_short/happyoyster-directing-delete-world-api-reference-3e47ecd2da7486dd.md)：删除不再使用的 World。
-   World 为 `ready` 时可[获取体验凭证](raw/_short/happyoyster-directing-get-travel-credential-api--3e983dc0416050b9.md)。
