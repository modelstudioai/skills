...
-   妙搜SaaS产品地址：[妙搜控制台](https://aimiaobi.console.aliyun.com/?product_code=g_broadscope_search&from=bailian#/search_copilot_reference)，接口地址：[妙搜-智能搜索](raw/_short/api-aimiaobi-2023-08-01-runsearchgeneration-008d7da322c502e5.md)；
-   妙读线上仅提供PaaS接口调用，接口地址：[获取文档信息](raw/_short/api-aimiaobi-2023-08-01-getdocinfo-1792f23538478a5f.md)。
...
-   妙读：[妙读最佳实践](raw/_short/miaodu-best-practices-d068233d541e966a.md)。
