...
本文介绍通过 WebSocket 连接访问 Qwen-Audio-3.1-ASR-Flash-Message 实时语音识别服务的接口地址、请求头和交互流程。

## 接口地址

WebSocket 接口地址如下，必须使用 `wss://` 协议：
...
客户端事件和服务端事件的详细说明，请参见[客户端事件](raw/_short/qwen-asr-message-client-events-0be34a3639cdd40b.md)和[服务端事件](raw/_short/qwen-asr-message-server-events-00d0c99c6769976f.md)。
