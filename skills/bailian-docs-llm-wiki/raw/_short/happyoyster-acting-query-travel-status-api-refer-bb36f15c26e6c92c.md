...
-   **前置条件**：使用[客户端进入房间](raw/_short/happyoyster-acting-enter-travel-api-reference-56ea4df0a872fdb7.md)接口返回的 `encryptedTravelId` 查询。
...
Acting 加密 Travel ID。由[客户端进入房间](raw/_short/happyoyster-acting-enter-travel-api-reference-56ea4df0a872fdb7.md)接口返回。
...
-   建议每 2–5 秒轮询。
-   `running` 和 `paused` 都允许调用[发送文本过程指令](raw/_short/happyoyster-acting-instruct-travel-api-reference-5c29e8efed3870dd.md)；在 `paused` 状态发送指令不会自动恢复 Travel。
-   本接口不返回 `mode`、`aspectRatio`、`playUrl`、`bgmUrl` 或 `sessionId`；播流配置与播放器方向以[进入房间](raw/_short/happyoyster-acting-enter-travel-api-reference-56ea4df0a872fdb7.md)响应为准。
...
-   [暂停Travel](raw/_short/happyoyster-acting-pause-travel-api-reference-65ff563386f561f7.md) / [恢复Travel](raw/_short/happyoyster-acting-resume-travel-api-reference-e2cfa0a73db72db0.md)。
-   [结束Travel](raw/_short/happyoyster-acting-end-travel-api-reference-07665d664cc3dbc3.md)：结束后查询产物。
