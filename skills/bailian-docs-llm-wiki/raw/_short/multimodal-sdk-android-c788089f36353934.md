...
-   **EntranceActivity** 入口页面，需要修改url/api\_key/app\_id等信息。
    ...
    -   使用 License 模式，请参考子文档【[使用 License 模式接入Android SDK](raw/_short/multimodal-license-android-3b25b8626783d21f.md)】。
...
参数说明参考下方 [parameters.upstream的参数说明](raw/_short/multimodal-sdk-android-c788089f36353934.md)表格
...
参数说明参考下方 [parameters.downstream的参数说明](raw/_short/multimodal-sdk-android-c788089f36353934.md)表格
...
参数说明参考下方 [parameters.client\_info的参数说明](raw/_short/multimodal-sdk-android-c788089f36353934.md)表格
...
参数说明参考下方 [parameters.biz\_params的参数说明](raw/_short/multimodal-sdk-android-c788089f36353934.md)表格
...
三种模式的对比可以参考下方的[客户端使用的三种模式对比](raw/_short/multimodal-sdk-android-c788089f36353934.md)表格。
...
用于设置用户自定义prompt变量，由用户自定义设置json中的key和value。管控台上配置自定义prompt变量的方法参考[应用配置-提示词](raw/application-user-guide/application-gallery/multimodal-products/multimodal-guidelines/multimodal-app-configuration.md)
...
用于设置用户自定义对话变量，由用户自定义设置json中的key和value。管控台上配置自定义对话变量的方法参考[应用配置-对话变量](raw/application-user-guide/application-gallery/multimodal-products/multimodal-guidelines/multimodal-app-configuration.md)
...
[RequestToSpeak](raw/_short/multimodal-interaction-protocol-8062cfbb96fec75a.md)消息打断
