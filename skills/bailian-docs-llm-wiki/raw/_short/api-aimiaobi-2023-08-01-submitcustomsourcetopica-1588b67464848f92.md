...
[百炼业务空间 ID](raw/application-api-reference/application-call/obtain-the-app-id-and-workspace-id.md)
...
[HottopicNews](raw/_short/api-aimiaobi-2023-08-01-hottopicnews-1dcf3cfc4b7f2c7e.md)
...
3.  支持将分析结果导出为 json 或者 excel。参考[导出接口](raw/_short/api-aimiaobi-2023-08-01-exportcustomsourceanalys-67d4a70d158d53c4.md)的 ExportType 字段
    
4.  最佳实践请参考：[妙策自定义数据源最佳实践](https://help.aliyun.com/zh/model-studio/best-practices-for-miaoce-api#42209ec83blza)
