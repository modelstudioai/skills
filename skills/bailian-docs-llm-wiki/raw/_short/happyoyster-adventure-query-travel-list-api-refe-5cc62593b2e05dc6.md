...
-   [查询Travel状态](raw/_short/happyoyster-adventure-query-travel-status-api-re-c8c769da81dc5895.md)：查询单个 Travel 的实时状态。
-   [查询Travel产物](raw/_short/happyoyster-adventure-query-travel-artifacts-api-ae37da872a0bc999.md)：查询已完成 Travel 的视频产物。
