...
-   **前置条件**：使用[创建World](raw/_short/happyoyster-acting-create-world-api-reference-47f1f4ec26522c7d.md)接口返回的 `encryptedWorldId` 删除。
...
要删除的 Acting 加密 World ID。由[创建World](raw/_short/happyoyster-acting-create-world-api-reference-47f1f4ec26522c7d.md)接口返回。
...
-   [查询World列表](raw/_short/happyoyster-acting-query-world-list-api-referenc-3550b0de031bc3dc.md)：查看剩余 Acting World。
-   [创建World](raw/_short/happyoyster-acting-create-world-api-reference-47f1f4ec26522c7d.md)：创建新的 Acting World。
