...
-   微调产出的模型：使用[创建调优任务](raw/_short/video-generation-create-fine-tuning-job-api-2357b2afaa3e843c.md)响应中 `output.finetuned_output` 的值，格式如 `wan2.5-i2v-preview-ft-202511111122-xxxx`。
