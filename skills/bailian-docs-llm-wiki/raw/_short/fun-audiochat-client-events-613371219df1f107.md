...
**用户指南**：[实时语音对话（Qwen-Audio-Realtime）](https://help.aliyun.com/zh/model-studio/fun-audiochat-realtime)。如需了解事件交互时序，请参见[WebSocket API](raw/_short/fun-audiochat-realtime-websocket-api-66b5ba4f8a668f28.md)。
