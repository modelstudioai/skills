...
-   **参数说明**
    ...
    **说明**
    ...
    是否保存本地日志。若为`YES`，须通过[`debug_path`](raw/_short/cosyvoice-ios-sdk-1995754e712f9554.md)指定路径，并可通过[`max_log_file_size`](raw/_short/cosyvoice-ios-sdk-1995754e712f9554.md)设置文件大小。
...
-   **ticket 参数说明**
    ...
    **说明**
    ...
    此参数仅在调用[startStreamInputTts](https://help.aliyun.com/zh/model-studio/cosyvoice-ios-sdk#8c10225a80wsk)、[playStreamInputTts](https://help.aliyun.com/zh/model-studio/cosyvoice-ios-sdk#be00eb5c18hnz)或[asyncPlayStreamInputTts](https://help.aliyun.com/zh/model-studio/cosyvoice-ios-sdk#2d43b13c45u3g)接口时将[`saveLog`](raw/_short/cosyvoice-ios-sdk-1995754e712f9554.md)设为YES时生效。此时必须设置日志文件路径，否则将报错。
    ...
    注意：`log_track_level`与[`logLevel`](raw/_short/cosyvoice-ios-sdk-1995754e712f9554.md)（通过[startStreamInputTts](https://help.aliyun.com/zh/model-studio/cosyvoice-ios-sdk#8c10225a80wsk)、[playStreamInputTts](https://help.aliyun.com/zh/model-studio/cosyvoice-ios-sdk#be00eb5c18hnz)或[asyncPlayStreamInputTts](https://help.aliyun.com/zh/model-studio/cosyvoice-ios-sdk#2d43b13c45u3g)接口设置）共同决定最终回调的日志。一条日志的级别数值必须同时大于或等于`log_track_level`和[`logLevel`](raw/_short/cosyvoice-ios-sdk-1995754e712f9554.md)的值，才会被回调。例如，`log_track_level`设为2 (INFO)，[`logLevel`](raw/_short/cosyvoice-ios-sdk-1995754e712f9554.md)设为3 (WARNING)，则只有WARNING及以上级别（数值>=3）的日志才会被回调。
...
阻塞等待的超时时间由参数 [complete\_waiting\_ms](raw/_short/cosyvoice-ios-sdk-1995754e712f9554.md) 控制。
...
该接口默认启用[SSML](https://help.aliyun.com/zh/model-studio/ssml-latex-user-guide)，可通过parameters中的[`enable_ssml`](raw/_short/cosyvoice-ios-sdk-1995754e712f9554.md)参数关闭。
...
2.  **下载SDK并运行示例代码：**
    -   [下载最新SDK整合包](https://help.aliyun.com/zh/model-studio/sdk-selection-and-download)。
...
**使用限制**：仅支持[一次性输入待合成文本](raw/_short/cosyvoice-ios-sdk-1995754e712f9554.md)（`playStreamInputTts` 或 `asyncPlayStreamInputTts` 接口），不支持[流式输入待合成文本](raw/_short/cosyvoice-ios-sdk-1995754e712f9554.md)（`sendStreamInputTts`接口）。
