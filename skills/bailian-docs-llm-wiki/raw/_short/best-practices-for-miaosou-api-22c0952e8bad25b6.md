...
#### API：[系统配置-信源管理](raw/_short/api-aimiaobi-2023-08-01-dir-system-configuration-ca1a4ce27f44ef5a.md)
...
-   [妙搜-数据源](raw/_short/api-aimiaobi-2023-08-01-dir-wonderful-search-dat-5a0812c7a1fd2fb7.md)：维护企业知识
    
    -   [数据源-创建](raw/_short/api-aimiaobi-2023-08-01-createdataset-9cf2fa0cba66e0a0.md)
    -   [数据源-详情](raw/_short/api-aimiaobi-2023-08-01-getdataset-afa789c817f35796.md)
    -   [数据源-修改](raw/_short/api-aimiaobi-2023-08-01-updatedataset-4e703cba19f41d7d.md)
    -   [数据源-列表](raw/_short/api-aimiaobi-2023-08-01-listdatasets-2313cd6272804496.md)
    -   [数据源-删除](raw/_short/api-aimiaobi-2023-08-01-deletedataset-1ea96ab7e4a8eed5.md)
    -   [数据源-添加文档到数据集](raw/_short/api-aimiaobi-2023-08-01-adddatasetdocument-d634038ff7246468.md)
    -   [数据源-获取文档详情](raw/_short/api-aimiaobi-2023-08-01-getdatasetdocument-288cb4bd87c944f5.md)
    -   [数据源-修改文档](raw/_short/api-aimiaobi-2023-08-01-updatedatasetdocument-18ab686c5f35fc8b.md)
    -   [数据源-文档列表](raw/_short/api-aimiaobi-2023-08-01-listdatasetdocuments-e5d9a8f76f09beb3.md)
    -   [数据源-搜索文档](raw/_short/api-aimiaobi-2023-08-01-searchdatasetdocuments-dc8b0ab1d58aa26c.md)
    -   [数据源-删除数据集文档](raw/_short/api-aimiaobi-2023-08-01-deletedatasetdocument-9e9a8e3a4e6a76c3.md)
-   [系统配置-信源管理](raw/_short/api-aimiaobi-2023-08-01-dir-system-configuration-ca1a4ce27f44ef5a.md)：配置信源，可以通过控制台配置
    
    -   [保存信源权重配置](raw/_short/api-aimiaobi-2023-08-01-savedatasourceorderconfi-11a35e9d66ef9dfb.md)
    -   [获取信源配置权重数据](raw/_short/api-aimiaobi-2023-08-01-getdatasourceorderconfig-e2d6ff83ddbb8c7a.md)
-   [妙搜-智能搜索](raw/_short/api-aimiaobi-2023-08-01-runsearchgeneration-008d7da322c502e5.md)：端到端智能搜索生成推理能力
    
    -   [妙搜-智能搜索](raw/_short/api-aimiaobi-2023-08-01-runsearchgeneration-008d7da322c502e5.md)
    -   [查询妙搜搜索生成历史任务列表](raw/_short/api-aimiaobi-2023-08-01-listsearchtasks-16cba5cd29273c99.md)
    -   [查询妙搜搜索生成任务详情列表](raw/_short/api-aimiaobi-2023-08-01-listsearchtaskdialogues-3d8d4525ce15ac3c.md)
    -   [查询搜索生成任务对话详情中数据列表](raw/_short/api-aimiaobi-2023-08-01-listsearchtaskdialogueda-40b8e7ed38a3461c.md)
...
1.  准备三方企业搜索API：
    ...
    1.  按照推荐的API模板提供API（非标、或不支持的鉴权需要定开）：[三方搜索API规范](raw/_short/third-party-search-api-template-361000c6f516d9a8.md)。
2.  配置三方企业搜索API：
