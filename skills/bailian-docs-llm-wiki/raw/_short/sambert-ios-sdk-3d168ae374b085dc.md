...
1.  [`nui_tts_initialize()`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md) - 初始化SDK，设置回调接口和连接参数
2.  [`nui_tts_set_param()`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md) - 设置语音合成效果参数（模型、音色、音量等）
3.  [`nui_tts_play()`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md) - 启动语音合成任务
4.  [`onNuiTtsUserdataCallback()`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md) - 接收音频数据
5.  [`nui_tts_release()`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md) - 释放SDK资源

### Sambert 方法

#### nui\_tts\_initialize

初始化语音合成SDK实例。SDK为单例模式，在调用 [`nui_tts_release`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)前禁止重复初始化。
...
此参数仅在调用[nui\_tts\_initialize](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)接口时将[`save_log`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)设为`YES`时生效。此时必须设置日志文件路径，否则将报错。
...
此参数仅在调用[nui\_tts\_initialize](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)接口时将[`save_log`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)设为`YES`时生效。
...
控制通过日志回调（[onNuiTtsLogTrackCallback](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)）对外发送的日志内容的过滤级别。
...
注意：`log_track_level`与[`level`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)（通过[nui\_tts\_initialize](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)接口设置）共同决定最终回调的日志。一条日志的级别数值必须同时大于或等于`log_track_level`和[`level`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)的值，才会被回调。例如，`log_track_level`设为2 (INFO)，[`level`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)设为3 (WARNING)，则只有WARNING及以上级别（数值>=3）的日志才会被回调。

#### nui\_tts\_set\_param

以键值对的形式设置参数。在 [`nui_tts_play`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)之前调用。
...
1.  初始化 SDK。
2.  按业务需求设置参数：通过[`nui_tts_initialize`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)接口的`parameters`参数设置连接参数；通过[`nui_tts_set_param`](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)接口设置语音合成效果参数。
3.  调用 `nui_tts_play` 开始语音合成。
4.  在[onNuiTtsUserdataCallback](raw/_short/sambert-ios-sdk-3d168ae374b085dc.md)回调中获取音频数据，建议使用流式播放。如需保存本地，按追加模式将音频写入同一文件，直到合成完成。
