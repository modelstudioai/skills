...
-   `qwen-vl-ocr-latest`、`qwen-vl-ocr-2025-11-20`：每 Token 对应像素为`32*32`。
...
-   `qwen-vl-ocr-latest`、`qwen-vl-ocr-2025-11-20`：默认值和最小值均为3072（即`3×32×32`）
...
-   `qwen-vl-ocr-latest`、`qwen-vl-ocr-2025-11-20`、`qwen-vl-ocr-2024-10-28`默认值与最大值均为模型的最大输出长度，请参见[支持的模型](https://help.aliyun.com/zh/model-studio/qwen-vl-ocr#f4299b0a1ace4)。
