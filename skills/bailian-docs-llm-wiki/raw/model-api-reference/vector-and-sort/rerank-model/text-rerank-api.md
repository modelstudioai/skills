...
您需要已[获取 API Key](raw/model-api-reference/preparations/get-api-key.md)并[配置API Key到环境变量DASHSCOPE\_API\_KEY](raw/model-api-reference/preparations/get-api-key.md)。如果通过SDK调用，还需要[安装DashScope SDK](raw/model-api-reference/preparations/install-sdk.md)。
