...
Flowable是RxJava中表示响应式数据流的类型，支持背压。关于Flowable的使用，请参见[Flowable API详情](http://reactivex.io/RxJava/2.x/javadoc/)。
...
在DashScope Java SDK中，采用了OkHttp3的连接池技术，以减少重复建立连接的开销。详情请参见[高并发最佳实践](https://help.aliyun.com/zh/model-studio/realtime-tts-user-guide#ug_hc_h3)。
