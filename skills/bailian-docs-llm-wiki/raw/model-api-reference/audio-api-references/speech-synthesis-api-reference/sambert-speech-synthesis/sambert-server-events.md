...
**sentence.begin\_time**`integer`

句子开始时间戳，单位：毫秒。

**sentence.end\_time**`integer`
...
**phonemes**`array`**（需启用 phoneme\_timestamp\_enabled）**
...
**header.error\_code**`string`

错误码。

**header.error\_message**`string`
