...
**参考指代**：在prompt中通过“**\[Image 1\]、\[Image 2\]**”标识指代`media`数组中对应位置的参考图像，顺序与`media`数组顺序一致。使用时需要指明参考图中的具体对象，例如“\[Image 1\]中身着红色旗袍的女性”。
...
-   数组中的第 1 个`reference_image`对应 **\[Image 1\]**，第 2 个对应 **\[Image 2\]**，以此类推。
