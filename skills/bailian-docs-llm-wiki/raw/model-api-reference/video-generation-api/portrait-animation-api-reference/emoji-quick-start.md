...
-   **步骤一：图像检测**
    ...
    调用[Emoji 图像检测API](raw/model-api-reference/video-generation-api/portrait-animation-api-reference/emoji-quick-start/emoji-detect-api.md)，确保人像图片合规，并获取人脸区域和表情包动态区域的坐标。
    
-   **步骤二：视频生成**
    
    调用[Emoji 视频生成API](raw/model-api-reference/video-generation-api/portrait-animation-api-reference/emoji-quick-start/emoji-api.md)，传入通过检测的人像图片、上一步获取的坐标、在[表情包模板ID列表](https://help.aliyun.com/zh/model-studio/emoji-api#552aacbdadtaq)选择的模板ID，生成表情包视频。
