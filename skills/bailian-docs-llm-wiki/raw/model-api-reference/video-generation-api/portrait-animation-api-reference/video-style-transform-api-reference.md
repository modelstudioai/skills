...
在调用前，您需要[获取 API Key](raw/model-api-reference/preparations/get-api-key.md)，再[配置API Key为环境变量DASHSCOPE\_API\_KEY](raw/model-api-reference/preparations/get-api-key.md)。
