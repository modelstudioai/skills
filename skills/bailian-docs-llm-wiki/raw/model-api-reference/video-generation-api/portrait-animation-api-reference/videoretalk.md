...
-   调用“声动人像VideoRetalk”模型，输入画面清晰且正面镜头的人物视频，以及人声清晰的音频文件，即可生成人物口型替换视频。具体操作请参见[VideoRetalk视频生成](raw/model-api-reference/video-generation-api/portrait-animation-api-reference/videoretalk/videoretalk-api.md)。
