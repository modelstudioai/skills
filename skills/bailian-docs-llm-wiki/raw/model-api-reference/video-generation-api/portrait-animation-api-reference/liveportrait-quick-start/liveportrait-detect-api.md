...
该模型用于检测输入的图片是否满足“[LivePortrait 视频生成](raw/model-api-reference/video-generation-api/portrait-animation-api-reference/liveportrait-quick-start/liveportrait-api.md)”所需的人物肖像图片规范。
