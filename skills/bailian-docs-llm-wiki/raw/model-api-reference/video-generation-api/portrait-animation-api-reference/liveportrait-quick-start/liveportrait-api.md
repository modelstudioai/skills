...
-   输入图像已通过[LivePortrait 图像检测](raw/model-api-reference/video-generation-api/portrait-animation-api-reference/liveportrait-quick-start/liveportrait-detect-api.md)检测。
...
用户上传的图片 URL，该图应先通过[LivePortrait图像检测API](raw/model-api-reference/video-generation-api/portrait-animation-api-reference/liveportrait-quick-start/liveportrait-detect-api.md)。
...
parameters.mouth\_move\_strength
...
parameters.head\_move\_strength
...
def sample_async_call():
    ...
    rsp = VideoSynthesis.async_call(api_key=api_key,
                                model='liveportrait',
                                img_url='https://help-static-aliyun-doc.aliyuncs.com/file-manage-files/zh-CN/20250911/ynhjrg/p874909.png',
                                audio_url='https://help-static-aliyun-doc.aliyuncs.com/file-manage-files/zh-CN/20251226/fwnqyq/liveportrait_boy.mp3',
                                template_id='normal',
                                eye_move_freq=0.5,
                                video_fps=30,
...
如果作业成功，包含模型生成的结果 object，然后每个 object 中包含按照要求生成的结果地址。**video\_url有效期为作业完成后24小时**。
