...
**重要**resolution直接影响费用，请在调用前确认[模型价格](raw/model-user-guide/test-1/model-pricing.md)。
...
**重要**duration直接影响费用，按秒计费，请在调用前确认[模型价格](raw/model-user-guide/test-1/model-pricing.md)。
