...
支持模型：pixverse/pixverse-c1-r2v、pixverse/pixverse-v5.6-r2v。
...
duration直接影响费用，请在调用前确认[爱诗-参考生视频](https://help.aliyun.com/zh/model-studio/model-pricing#pxr002a0h3001)。
...
audio直接影响费用，请在调用前确认[爱诗-参考生视频](https://help.aliyun.com/zh/model-studio/model-pricing#pxr002a0h3001)。
