...
-   size直接影响费用，请在调用前确认[模型价格](https://help.aliyun.com/zh/model-studio/model-pricing#pxt002a0h3001)。
-   使用pixverse/pixverse-v5.6-t2v模型，若设置size为1808_1808，且duration为8时，实际输出的视频分辨率为1440_1440。
...
**重要**duration直接影响费用，按秒计费，请在调用前确认[模型价格](https://help.aliyun.com/zh/model-studio/model-pricing#pxt002a0h3001)。
...
**重要**audio直接影响费用，请在调用前确认[模型价格](https://help.aliyun.com/zh/model-studio/model-pricing#pxt002a0h3001)。
...
SDK 的参数命名与[HTTP接口](https://help.aliyun.com/zh/model-studio/pixverse-text-to-video-api-reference#pv101a0h2http)基本一致，参数结构根据语言特性进行封装。
