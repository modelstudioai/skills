...
**重要**duration直接影响费用，请在调用前确认[爱诗-参考生视频](raw/model-user-guide/test-1/model-pricing.md)。
...
**重要**audio直接影响费用，请在调用前确认[爱诗-参考生视频](raw/model-user-guide/test-1/model-pricing.md)。
