...
-   [VAD 模式](https://help.aliyun.com/zh/model-studio/realtime)：服务端自动提交音频缓冲区，客户端无需发送此事件。
-   [Manual 模式](https://help.aliyun.com/zh/model-studio/realtime)：客户端必须提交音频缓冲区才能创建用户消息项。
