...
> 相关文档：[深入研究（Qwen-Deep-Research）](raw/model-user-guide/model-experience/text-generation-model/specialized-models/qwen-deep-research.md)

**重要**Qwen-Deep-Research模型仅支持华北2（北京）地域，如需使用模型，请使用华北2（北京）地域的[API Key](https://bailian.console.aliyun.com/model/settings/api-key)。
