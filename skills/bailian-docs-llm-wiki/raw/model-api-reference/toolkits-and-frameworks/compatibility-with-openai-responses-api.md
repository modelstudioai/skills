...
您需要先[获取与配置 API Key](raw/model-api-reference/preparations/get-api-key.md)并[配置API Key到环境变量](https://help.aliyun.com/zh/model-studio/configure-api-key-through-environment-variables)。若通过 OpenAI SDK 进行调用，需要[安装SDK](raw/model-api-reference/preparations/install-sdk.md)。

## 支持的模型

#### 华北2（北京）

`qwen3.8-max`、`qwen3.8-flash`、`qwen3.7-max`、`qwen3.7-max-2026-05-20`、`qwen3.7-max-2026-06-08`、`qwen3-max`、`qwen3-max-2026-01-23`、`qwen3.7-plus`、`qwen3.7-plus-2026-05-26`、`qwen3.6-plus`、`qwen3.6-plus-2026-04-02`、`qwen3.5-plus`、`qwen3.5-plus-2026-04-20`、`qwen3.5-plus-2026-02-15`、`qwen3.7-flash`、`qwen3.7-flash-2026-07-15`、`qwen3.6-flash`、`qwen3.6-flash-2026-04-16`、`qwen3.5-flash`、`qwen3.5-flash-2026-02-23`、`qwen3.8-2.4t-a95b`、`qwen3.8-27b`、`qwen3.6-35b-a3b`、`qwen3.5-397b-a17b`、`qwen3.5-122b-a10b`、`qwen3.5-27b`、`qwen3.5-35b-a3b`、`qwen-plus`、`qwen-flash`、`qwen3-coder-plus`、`qwen3-coder-flash`、`qwen3.5-ocr`、`qwen-plus-character`、`qwen-flash-character`、`deepseek-v4-pro`、`deepseek-v4-pro-0813`、`deepseek-v4-flash`、`deepseek-v4-flash-0731`、`glm-5.2`

#### 新加坡

**国际部署范围**

`qwen3.8-max`、`qwen3.8-flash`、`qwen3.7-max`、`qwen3.7-max-2026-05-20`、`qwen3.7-max-2026-06-08`、`qwen3-max`、`qwen3-max-2026-01-23`、`qwen3.7-plus`、`qwen3.7-plus-2026-05-26`、`qwen3.6-plus`、`qwen3.6-plus-2026-04-02`、`qwen3.5-plus`、`qwen3.5-plus-2026-04-20`、`qwen3.5-plus-2026-02-15`、`qwen3.7-flash`、`qwen3.7-flash-2026-07-15`、`qwen3.6-flash`、`qwen3.6-flash-2026-04-16`、`qwen3.5-flash`、`qwen3.5-flash-2026-02-23`、`qwen3.8-2.4t-a95b`、`qwen3.8-27b`、`qwen3.6-35b-a3b`、`qwen3.5-397b-a17b`、`qwen3.5-122b-a10b`、`qwen3.5-27b`、`qwen3.5-35b-a3b`、`qwen-plus`、`qwen-flash`、`qwen3-coder-plus`、`qwen3-coder-flash`、`qwen-plus-character`、`qwen-flash-character`、`deepseek-v4-pro`、`deepseek-v4-pro-0813`、`deepseek-v4-flash`、`deepseek-v4-flash-0731`、`glm-5.2`

#### 美国（弗吉尼亚）

**全球部署范围**

`qwen3.8-max 、 qwen3.8-flash 、 qwen3.7-max 、 qwen3.7-max-2026-05-20 、 qwen3.7-max-2026-06-08 、 qwen3.7-plus 、 qwen3.7-plus-2026-05-26 、 qwen3.6-plus 、 qwen3.6-plus-2026-04-02 、 qwen3.5-plus 、 qwen3.5-plus-2026-02-15 、 qwen3.7-flash 、 qwen3.7-flash-2026-07-15 、 qwen3.6-flash 、 qwen3.6-flash-2026-04-16 、 qwen3.5-flash 、 qwen3.5-flash-2026-02-23 、 qwen3.6-35b-a3b 、 qwen3.5-397b-a17b 、 qwen3.5-122b-a10b 、 qwen3.5-27b 、 qwen3.5-35b-a3b`

#### 德国（法兰克福）

**全球部署范围**

`qwen3.8-max`、`qwen3.8-flash`、`qwen3.7-max`、`qwen3.7-max-2026-05-20`、`qwen3.7-max-2026-06-08`、`qwen3.7-plus`、`qwen3.7-plus-2026-05-26`、`qwen3.7-flash`、`qwen3.7-flash-2026-07-15`、`qwen3.5-397b-a17b`、`qwen3.5-122b-a10b`、`qwen3.5-35b-a3b`、`qwen3.5-27b`
...
`qwen3.7-plus`、`qwen3.7-plus-2026-05-26`、`qwen3.8-max`、`qwen3.8-flash`、`qwen3.7-max`、`qwen3.7-max-2026-05-20`、`qwen3.6-plus`、`qwen3.6-plus-2026-04-02`、`qwen3.7-flash`、`qwen3.7-flash-2026-07-15`、`qwen3.6-flash`、`qwen3.6-flash-2026-04-16`
...
-   启用 Session 缓存：
    ...
    -   模型支持显式缓存：使用显式缓存，计费和相关约束参照[显式缓存](https://help.aliyun.com/zh/model-studio/context-cache#825f201c5fy6o)。
    -   模型不支持显式缓存但支持隐式缓存：使用隐式缓存，计费和相关约束参照[隐式缓存](https://help.aliyun.com/zh/model-studio/context-cache#2317ea09cfxok)。
-   不启用 Session 缓存：与正常调用行为一致。支持隐式缓存的模型，隐式缓存仍自动开启，但不享受 Session 缓存带来的增益。
