...
-   列表项是轻量快照，不返回图片、Prompt、`refWorldId` 或其它完整创建参数；需要完整配置时调用[查询World详情](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-adventure-openapi-reference/happyoyster-adventure-query-world-detail-api-reference.md)。
...
-   [查询World详情](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-adventure-openapi-reference/happyoyster-adventure-query-world-detail-api-reference.md)：查看单个 World 完整元数据。
