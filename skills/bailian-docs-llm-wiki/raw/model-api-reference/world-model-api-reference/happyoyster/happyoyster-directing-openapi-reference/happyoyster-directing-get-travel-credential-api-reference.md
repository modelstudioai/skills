# HappyOyster-Directing-获取体验凭证 API参考
...
-   **前置条件**：World 必须属于当前主账号和 Directing 模型，且状态为 `ready`。可通过[查询World构建状态](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-query-world-build-status-api-reference.md)接口确认。
...
当前主账号名下、状态为 `ready` 的 Directing World ID。由[创建World](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-create-world-api-reference.md)接口返回。
...
-   调用本接口不会创建 Travel；Travel 在[进入房间](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-enter-travel-api-reference.md)成功时创建。
...
-   [客户端进入房间](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-enter-travel-api-reference.md)：客户端使用 `ticket` 创建 Travel 并获取 RTC 配置。
