...
-   **调用模式**：推荐使用异步模式。
    ...
    -   **异步模式**（默认）：`async=true`，接口立即返回 `encryptedWorldId`，需轮询[查询World构建状态](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-query-world-build-status-api-reference.md)获取进度。
...
-   `true`：立即返回，World 在后台构建，客户端轮询[查询World构建状态](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-query-world-build-status-api-reference.md)。
...
-   **ScriptList 提交要求**：创建 World 时 `acts` 最多 45 条，不要求恰好 45 条；Travel 中调用 [update-script](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-update-script-api-reference.md) 时才要求完整提交 45 条。
    
-   **Travel 控制接口**：`creationModel` 中列出的接口名是 World 创建后、在 Travel 阶段可调用的服务端接口，不是本接口的入参枚举值。含义如下：
    
    -   `instruct`：向运行中的 Travel 发送[文本过程指令](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-instruct-travel-api-reference.md)，仅普通模式。
    -   `pause`：[暂停](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-pause-travel-api-reference.md) Travel。
    -   `resume`：[恢复](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-resume-travel-api-reference.md)播放。
    -   `rewind`：[回溯](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-rewind-travel-api-reference.md)到指定时间点，需先暂停。
    -   `end`：[结束](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-end-travel-api-reference.md) Travel。
    -   `update-script`：[全量替换剧本](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-update-script-api-reference.md)，仅剧本模式。
...
-   [查询World构建状态](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-query-world-build-status-api-reference.md)：每 3–5 秒轮询，直到 World 进入 `ready`。
-   World 进入 `ready` 后，调用[获取体验凭证](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-get-travel-credential-api-reference.md)换取一次性 `ticket`。
-   [查询World详情](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-query-world-detail-api-reference.md)：查询完整创建元数据和 ScriptList。
