# HappyOyster-Directing-恢复Travel API参考

恢复已暂停的 Directing Travel，使其重新进入运行状态。

## 适用范围

恢复已暂停的 Directing Travel，使其重新进入运行状态。调用前请确认以下事项：
...
-   **前置条件**：Travel 必须已通过[查询Travel状态](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-query-travel-status-api-reference.md)确认为 `paused`。
-   **调用方**：您的服务端或客户端均可调用。
...
要恢复的 Directing 加密 Travel ID。由[客户端进入房间](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-enter-travel-api-reference.md)接口返回。
...
-   Travel 必须已通过[查询Travel状态](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-query-travel-status-api-reference.md)确认为 `paused`。
-   进房响应中的 `version` 必须为 `storyV2`。
-   已结束或失败的 Travel 不能恢复。
...
-   [查询Travel状态](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-query-travel-status-api-reference.md)：确认 Travel 回到 `running`。
