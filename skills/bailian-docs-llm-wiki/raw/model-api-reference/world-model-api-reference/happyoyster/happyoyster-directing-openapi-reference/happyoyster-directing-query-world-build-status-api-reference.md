...
-   **前置条件**：使用[创建World](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-create-world-api-reference.md)接口返回的 `encryptedWorldId` 查询。可从 `generating` 状态开始查询。
-   **调用方**：您的服务端或客户端均可调用。
...
[创建World](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-create-world-api-reference.md)接口返回的 Directing 加密 World ID。
...
-   只有 `ready` 的 World 才能[换取体验凭证](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-get-travel-credential-api-reference.md)并[进入房间](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-enter-travel-api-reference.md)。
...
-   [获取体验凭证](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-get-travel-credential-api-reference.md)：换取一次性 `ticket`。
-   [查询World详情](raw/model-api-reference/world-model-api-reference/happyoyster/happyoyster-directing-openapi-reference/happyoyster-directing-query-world-detail-api-reference.md)：查询完整创建元数据。
