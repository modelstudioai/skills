...
-   此查询接口的默认RPS为1。如需更高频次的查询或事件通知，请[配置异步任务回调](raw/model-api-reference/more-about-models/async-task-api.md)。
...
请求失败的详细信息，详情请参见[错误码](raw/model-api-reference/preparations/error-code.md)。
