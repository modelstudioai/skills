...
千问图像生成与编辑3.0系列，同时支持文生图（T2I）和图生图/图像编辑（I2I）。3.0系列API调用请参阅[千问-图像生成与编辑3.0](https://help.aliyun.com/zh/model-studio/qwen-image-generation-and-editing-api-reference)。
