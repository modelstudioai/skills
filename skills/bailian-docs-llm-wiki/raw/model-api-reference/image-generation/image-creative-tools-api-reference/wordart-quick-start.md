...
2.  WordArt锦书-文字纹理生成：[文字纹理生成API详情](raw/_short/fill-texture-effect-api-702f76f58b3dd251.md)
...
**说明**以下代码演示了如何使用文字纹理生成API。需要使用您的API-KEY替换示例中的_your-bailian-api-key_，代码才能正常运行。
...
有关WordArt锦书API的详细调用请参见[文字纹理生成API详情](raw/_short/fill-texture-effect-api-702f76f58b3dd251.md)、[文字变形API详情](raw/model-api-reference/image-generation/image-creative-tools-api-reference/wordart-quick-start/word-transformer.md)。
