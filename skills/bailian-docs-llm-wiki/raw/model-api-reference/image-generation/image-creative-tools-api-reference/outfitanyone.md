...
[AI试衣-基础版](raw/model-api-reference/image-generation/image-creative-tools-api-reference/outfitanyone/outfitanyone-api.md)
...
[AI试衣-Plus版](raw/model-api-reference/image-generation/image-creative-tools-api-reference/outfitanyone/aitryon-plus-api.md)
...
[AI试衣-图片分割](raw/model-api-reference/image-generation/image-creative-tools-api-reference/outfitanyone/aitryon-parsing-api.md)
...
1.  准备输入：准备模特图片和服装图片。
2.  调用试衣模型：调用[AI试衣-基础版](raw/model-api-reference/image-generation/image-creative-tools-api-reference/outfitanyone/outfitanyone-api.md) 或[AI试衣-Plus版](raw/model-api-reference/image-generation/image-creative-tools-api-reference/outfitanyone/aitryon-plus-api.md)，将上述两张图片作为核心参数传入。
...
1.  提取保留服饰：调用[AI试衣-图片分割](raw/model-api-reference/image-generation/image-creative-tools-api-reference/outfitanyone/aitryon-parsing-api.md)，输入原始模特图，获取要保留的服饰图片（例如裤子）。
2.  组合试衣：调用[AI试衣-基础版](raw/model-api-reference/image-generation/image-creative-tools-api-reference/outfitanyone/outfitanyone-api.md) 或[AI试衣-Plus版](raw/model-api-reference/image-generation/image-creative-tools-api-reference/outfitanyone/aitryon-plus-api.md)，同时传入原始模特图、新的上衣图和上一步得到的裤子图。
...
1.  调用图片分割模型：调用[AI试衣-图片分割](raw/model-api-reference/image-generation/image-creative-tools-api-reference/outfitanyone/aitryon-parsing-api.md)，输入任意模特图（真实照片或AI试衣图均可）。
