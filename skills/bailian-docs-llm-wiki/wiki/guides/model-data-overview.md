...
- > **注意**：原始文档中提及「日志回流」为相关能力，但当前版本（v2024.09）中日志回流功能尚未开放给全部用户，其接入方式与权限范围与 [日志回流](https://help.aliyun.com/zh/model-studio/model-log-backflow) 文档描述存在滞后，建议以控制台实际可见选项为准。
