...
- [专用翻译模型与通用大语言模型对比](comparisons/translation-models-vs-llm.md) — 对比 3 个主题
...
- [模型部署方式对比：托管服务 vs 自定义部署](comparisons/model-deployment-options.md) — 对比 3 个主题
- [知识库与记忆库功能对比](comparisons/knowledge-base-vs-memory-library.md) — 对比 3 个主题
