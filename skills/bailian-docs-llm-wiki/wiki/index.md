...
- [Qwen系列模型能力对比（基础、多模态、翻译、决策）](comparisons/qwen-models-comparison.md) — 对比 3 个主题
- [图像、视频与3D内容生成能力对比](comparisons/image-video-3d-generation.md) — 对比 3 个主题
- [实时API方案对比（Omni Realtime vs Realtime User Guide）](comparisons/realtime-api-options.md) — 对比 2 个主题
- [模型部署方式对比（高并发推理、模型压缩、模型生产化）](comparisons/model-deployment-options.md) — 对比 3 个主题
- [长期记忆、知识库与托管智能体方案对比](comparisons/memory-knowledge-base-agents.md) — 对比 3 个主题
